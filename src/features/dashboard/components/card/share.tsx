...
const CardShare = () => {
  ...
  if (loading) {
    return (
      <div className="w-full max-w-2xl m-auto  shadow-xl border border-gray-200 rounded-xl">
  ...
  return (
    <Card
      ...
      className="w-full min-h-screen max-w-md m-auto shadow-xl border border-gray-200 rounded-xl"
    >
